# firebase_projects/CRUD_app

This is a Webapp tends to do CRUD (Create, Read, Update, Delete) operations on firebase/firestore.
...
**1.** Fork [this](https://github.com/fellowEngineer/firebase_projects/tree/main/CRUD_app) repository.

**2.** Star [this](https://github.com/fellowEngineer/firebase_projects/tree/main/CRUD_app) repository (Optional).
